...
|── test_telegram.sh # Автотест telegram 
...
cd ~
cd otp-service
sudo chmod +x test_telegram.sh
sudo ./test_telegram.sh
...
```
═══════════════════════════════════════════════════════════════════════════
                     РАБОЧИЙ ТЕСТ OTP SERVICE
═══════════════════════════════════════════════════════════════════════════

1. СОЗДАНИЕ ПОЛЬЗОВАТЕЛЯ В TELEGRAM
CHAT_ID: 1777823939183896
✅ Пользователь создан
...
4. ГЕНЕРАЦИЯ OTP
{
  ...
  "data": {
    "channel": "telegram",
    "operationId": "test_1777823939",
    "sent": true,
    "expiresAt": "2026-05-03T16:13:59.704466555"
  },
  "error": null
}
✅ OTP отправлен

5. ПОЛУЧЕНИЕ OTP КОДА ИЗ ЧАТОВ
Ожидание сообщения...
        echo -e "${GREEN}НАЙДЕНATTEMPT=1{NC}"
  Попытка 1/15... НАЙДЕНATTEMPT=1{NC}
Сообщение: 🔐 *OTP Verification Code*

Your verification code is: `97382799`

This code will expire in 5 minutes.
✅ OTP код получен: 97382799
        echo -e "${GREEN}✅ OTP валидирован успешно# 6. Валидация OTP{NC}"
...
✅ OTP валидирован успешно# 6. Валидация OTP{NC}

7. ПРОВЕРКА СТАТУСА В БД
Статус OTP: USED
✅ Статус корректный (USED)
...
📝 ДАННЫЕ ДЛЯ ВХОДА:
   Username: test_1777823939
   Password: pass123
   OTP Code: 97382799
   Operation ID: test_1777823939
═══════════════════════════════════════════════════════════════════════════
